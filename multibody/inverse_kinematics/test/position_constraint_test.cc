...
TEST_F(IiwaKinematicConstraintTest, PositionConstraint) {
  ...
  PositionConstraint constraint1(
      *plant_, frameB, p_BQ, frameA, p_AQ_lower, p_AQ_upper, plant_context_);
  ...
  plant_->tree().CalcPointsPositions(
      *plant_context_, frameB, p_BQ, frameA, &y_expected);
...
TEST_F(TwoFreeBodiesConstraintTest, PositionConstraint) {
  ...
  {
    PositionConstraint good_constraint(*plant_,
        plant_->tree().get_frame(body1_index_), p_BQ,
  ...
  {
    PositionConstraint bad_constraint(*plant_,
        plant_->tree().get_frame(body1_index_), p_BQ,
        plant_->tree().get_frame(body2_index_),
